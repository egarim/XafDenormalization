...
namespace XafDenormalization.Blazor.Server {
    public partial class XafDenormalizationBlazorApplication : BlazorApplication {
        public XafDenormalizationBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafDenormalizationBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
